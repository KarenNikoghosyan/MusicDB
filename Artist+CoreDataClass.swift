...
@objc(Artist)
public class Artist: NSManagedObject, Decodable {
    ...
    public convenience required init(from decoder: Decoder) throws {
        ...
        guard let entity = NSEntityDescription.entity(forEntityName: "Artist", in: Database.shared.context) else { fatalError() }

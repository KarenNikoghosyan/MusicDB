//
//  TopAlbumsArtist+CoreDataClass.swift
//  MusicDB
//
...
@objc(TopAlbumsArtist)
public class TopAlbumsArtist: NSManagedObject, Decodable {
    ...
    public convenience required init(from decoder: Decoder) throws {
        ...
        guard let entity = NSEntityDescription.entity(forEntityName: "TopAlbumsArtist", in: Database.shared.context) else { fatalError() }
        ...
        radio = try values.decodeIfPresent(Bool.self, forKey: .radio) ?? false
